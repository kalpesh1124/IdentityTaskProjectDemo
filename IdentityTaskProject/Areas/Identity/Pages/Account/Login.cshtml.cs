...
namespace IdentityTaskProject.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        RoleManager<IdentityRole> roleManager, SignInManager<ApplicationUser> signInManager, ILogger<LoginModel> logger, IdentityProjectContext context)
        {
        ...
        {
            returnUrl ??= Url.Content("~/Tasks/Create");
